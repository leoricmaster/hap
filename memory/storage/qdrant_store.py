...
from qdrant_client.http.models import (
    ...
    Filter, FieldCondition, MatchValue, SearchRequest, ValueVariants, Condition
)
                ...
                for key, value in where.items():
                    if isinstance(value, (str, int, float, bool)):
                        conditions.append(
                            FieldCondition(
                                key=key,
                                match=MatchValue(value=cast(ValueVariants, value))
                            )
                        )
    ...
    def delete_memories(self, memory_ids: List[str]):
        ...
        try:
            ...
            conditions: List[Condition] = [
                cast(Condition, FieldCondition(key="memory_id", match=MatchValue(value=mid)))
